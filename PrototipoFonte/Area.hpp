...
class Area
{
  public:
    ...
    Area(uint8_t inputPin, uint8_t outputPin, uint8_t channel, uint8_t samples, const double* polynomial, const double* reference, double Kp, double Ki, double Kd, double N, double Ts, bool OverWrite);

    Area(uint8_t inputPin0, uint8_t inputPin1, uint8_t outputPin0, uint8_t outputPin1, uint8_t channel0, uint8_t channel1, uint8_t samples, const double* polynomial0, const double* polynomial1, const double* reference0, const double* reference1, double Kp, double Ki, double Kd, double N, double Ts, bool OverWrite);
